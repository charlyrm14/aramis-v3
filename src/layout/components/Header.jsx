            ...
            <div className="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="#" className="d-lg-none">
                        <img alt="Logo" src="https://aramis.insuranceservices.mx/apple-touch-icon.png" className="h-25px" />
                    </a>
                </div>
                {/** end::Mobile logo*/}
                ...
                <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
						...
						<div className="d-flex align-items-stretch" id="kt_header_nav">
                            <div className="header-menu align-items-stretch" 
                                ...
                                data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                                    {/**begin::Menu*/}
                                    <div className="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-state-primary menu-title-gray-600 menu-arrow-gray-500 fw-semibold fs-6 my-5 my-lg-0 px-2 px-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                        {/**begin:Menu item*/}
                        ...
                        <div className="d-flex align-items-stretch justify-self-end flex-shrink-0">
                            ...
                            <div className="d-flex align-items-center ms-1 ms-lg-3">
                                {/**begin::Menu toggle*/}
                                <a href="#" className="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            ...
                            <div className="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div className="menu-item px-3">
                                        <div className="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div className="d-flex flex-column">
                                                <div className="fw-bold d-flex align-items-center fs-5">Juan P 
                                                <span className="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
                                                <a href="#" className="fw-semibold text-muted text-hover-primary fs-7">juan@correo.com</a>
                                            </div>
                                            {/**end::Username*/}
                                        </div>
                                    </div>
                                    ...
                                    <div className="menu-item px-5">
                                        <a href="#" className="menu-link px-5">Mi perfil</a>
                                    </div>
                                    {/**end::Menu item*/}
                                    {/**begin::Menu separator*/}
                                    <div className="separator my-2"></div>
                                    ...
                                    {/**begin::Menu item*/}
                                    <div className="menu-item px-5">
                                        <a href="#" className="menu-link px-5">Cerrar sesión </a>
                                    </div>
                                    {/**end::Menu item*/}
                                </div>
