                ...
                <div className="container-xxl" id="kt_content_container">
                    ...
                    <div className="row g-5 gx-xl-10 mb-5 mb-xl-10">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                            ...
                            <div className="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style={{backgroundColor: "#F1416C", backgroundImage: `url('../public/media/patterns/vector-1.png')`}}>
                                {/**begin::Header*/}
                                <div className="card-header pt-5">
                                    {/**begin::Title*/}
                                    <div className="card-title d-flex flex-column">
                                        {/**begin::Amount*/}
                                        <span className="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">9</span>
                                        {/**end::Amount*/}
                                        {/**begin::Subtitle*/}
                                        <span className="text-white opacity-75 pt-1 fw-semibold fs-6">Llamadas el día d ehoy</span>
                                        {/**end::Subtitle*/}
                                    </div>
                                    {/**end::Title*/}
                                </div>
                            ...
                            <div className="card card-flush h-md-50 mb-5 mb-xl-10 shadow">
                                ...
                                <div className="card-header pt-5">
                                    ...
                                    <div className="card-title d-flex flex-column">
                                        {/**begin::Amount*/}
                                        <span className="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">80</span>
                                        {/**end::Amount*/}
                                        {/**begin::Subtitle*/}
                                        <span className="text-gray-500 pt-1 fw-semibold fs-6">Llamadas en el mes</span>
                                        {/**end::Subtitle*/}
                                    </div>
                                    {/**end::Title*/}
                                </div>
                                ...
                                <div className="card-body d-flex flex-column justify-content-end pe-0">
                                    {/**begin::Title*/}
                                    <span className="fs-6 fw-bolder text-gray-800 d-block mb-2">Compañeros en línea</span>
                                    {/**end::Title*/}
                                    {/**begin::Users group*/}
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                            ...
                            <div className="card card-flush h-md-50 mb-5 mb-xl-10 shadow">
                                ...
                                <div className="card-header pt-5">
                                    ...
                                    <div className="card-title d-flex flex-column">
                                        ...
                                        {/**end::Info*/}
                                        {/**begin::Subtitle*/}
                                        <span className="text-gray-500 pt-1 fw-semibold fs-6">Tus ventas en abril</span>
                                        {/**end::Subtitle*/}
                                    </div>
                                    {/**end::Title*/}
                                </div>
                            ...
                            <div className="card card-flush h-lg-50 shadow">
                                ...
                                <div className="card-header pt-5">
                                    {/**begin::Title*/}
                                    <h3 className="card-title text-gray-800 fw-bold">Enlaces externos</h3>
                                    {/**end::Title*/}
                                    {/**begin::Toolbar*/}
                                ...
                                <div className="card-body pt-5">
                                    ...
                                    <div className="d-flex flex-stack">
                                        {/**begin::Section*/}
                                        <a href="#" className="text-primary fw-semibold fs-6 me-2">My Wallet</a>
                                        {/**end::Section*/}
                                        {/**begin::Action*/}
                                    ...
                                    <div className="d-flex flex-stack">
                                        {/**begin::Section*/}
                                        <a href="#" className="text-primary fw-semibold fs-6 me-2">Back Office</a>
                                        {/**end::Section*/}
                                        {/**begin::Action*/}
                                        <button type="button" className="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end">
                                            <i className="ki-outline ki-exit-right-corner fs-2"></i>
                                    ...
                                    <div className="d-flex flex-stack">
                                        {/**begin::Section*/}
                                        <a href="#" className="text-primary fw-semibold fs-6 me-2">Gmail</a>
                                        {/**end::Section*/}
                                        {/**begin::Action*/}
                                        <button type="button" className="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end">
                                            <i className="ki-outline ki-exit-right-corner fs-2"></i>
                        ...
                        <div className="col-xxl-6">
                            ...
                            <div className="card card-flush h-md-100 shadow">
                                {/**begin::Body*/}
                                <div className="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style={{backgroundPosition: "100% 50%", backgroundImage: `url('../public/media/stock/900x600/42.png')`}}>
                                    {/**begin::Wrapper*/}
                                    <div className="mb-10">
                                        {/**begin::Title*/}
                                        <div className="fs-2hx fw-bold text-gray-800 text-center mb-13">
                                        <span className="me-2">Esto es lo que has logrado durante este mes, ¡siéntete orgulloso!
                                        <br />
                                        <span className="position-relative d-inline-block text-danger">
                                            <a href="#" className="text-danger opacity-75-hover">¡Felicidades!</a>
                                            {/**begin::Separator*/}
                                        ...
                                        <div className="text-center">
                                            <a href='#' className="btn btn-sm btn-dark fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Mis estadisticas</a>
                                        </div>
                                        {/**begin::Action*/}
                                    </div>
                                    {/**begin::Wrapper*/}
                                    {/**begin::Illustration*/}
                                    <img className="mx-auto h-150px h-lg-200px theme-light-show" src="../public/media/illustrations/misc/upgrade.svg" alt="" />
                                    <img className="mx-auto h-150px h-lg-200px theme-dark-show" src="../public/media/illustrations/misc/upgrade-dark.svg" alt="" />
                                    {/**end::Illustration*/}
                                </div>
                                {/**end::Body*/}
                            </div>
